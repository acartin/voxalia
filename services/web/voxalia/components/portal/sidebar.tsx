...
import { Activity, BarChart3, BookOpenText, Bot, BriefcaseBusiness, Building2, Cable, CalendarClock, ChevronDown, ClipboardCheck, Cog, FileAudio, Headphones, Inbox, KeyRound, Link2, MessageCircle, PhoneCall, Radio, Route, ScrollText, Shield, Users } from "lucide-react";
...
const bubbleClasses: Record<string, string> = {
  ...
  "asterisk-infrastructure": "bg-[var(--teal-bg)] text-[var(--teal-text)]",
  asterisk: "bg-[var(--purple-bg)] text-[var(--purple-text)]",
  audit: "bg-[var(--coral-bg)] text-[var(--coral-text)]"
};

const collapsedSectionsKey = "voxalia-sidebar-collapsed-sections";
