...
export async function POST(
  ...
  const response = await fetch(`${ASTERISK_API_BASE_URL}/asterisk/tenants/${encodeURIComponent(tenantKey)}/flow-steps/${encodeURIComponent(id)}`, {
  ...
  return redirectPath(request, "success", method === "delete" ? "Flow step deleted successfully." : "Flow step updated successfully.");
}
