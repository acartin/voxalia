...
export async function POST(
  ...
  const response = await fetch(`${ASTERISK_API_BASE_URL}/asterisk/tenants/${encodeURIComponent(tenantKey)}/extensions/${encodeURIComponent(id)}`, {
  ...
  return redirectPath(request, "success", method === "delete" ? "Extension deleted successfully." : "Extension updated successfully.");
}
