...
export async function POST(
  ...
  const response = await fetch(`${ASTERISK_API_BASE_URL}/asterisk/tenants/${encodeURIComponent(tenantKey)}/extension-devices/${encodeURIComponent(id)}`, {
  ...
  return redirectPath(request, "success", method === "delete" ? "Extension device deleted successfully." : "Extension device updated successfully.");
}
