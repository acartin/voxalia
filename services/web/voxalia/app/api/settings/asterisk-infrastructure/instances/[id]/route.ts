...
export async function POST(
  ...
  const response = await fetch(`${ASTERISK_API_BASE_URL}/asterisk/infrastructure/instances/${encodeURIComponent(id)}`, {
  ...
  return redirectPath(
    request,
    "success",
    method === "delete" ? "Asterisk instance deleted successfully." : "Asterisk instance updated successfully."
  );
}
